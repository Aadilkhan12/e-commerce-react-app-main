          ...
          <>
            <div className="max-w-7xl mx-auto pt-4 pb-6 px-4">
              <div className="relative flex items-center justify-between h-16">
                ...
                <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start gap-2">
                  <div className="flex items-center justify-center border-2 rounded-full w-12 h-12">
                  ...
                  <div className={styles.logo}>
                    <Link className={styles.link} to="/">
                      <div className={styles.logoBox}>
                        <h1 className={styles.logoText}>shophub</h1>
                      </div>
                    </Link>
                  </div>
